...
```
`getAIDetectionAlert()` returns null when the completed webhook contains no suspected-ai-text alert. The raw JSON string stays available in `$aiAlert->additionalData`.
##
